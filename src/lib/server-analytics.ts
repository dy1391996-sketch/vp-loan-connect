...
const allowed = new Set(["homepage_visit", "assessment_started", "mobile_verified", "assessment_completed", "free_result_viewed", "checkout_opened", "payment_completed", "report_downloaded", "referral_link_copied", "whatsapp_share_clicked", "consultation_requested"]);
