...
function Restricted() { return <PublicStatePanel icon={MessageCircle} eyebrow="Consultation access" title="Secure assessment link required" description="Open the consultation request from your verified assessment result." action={{ href: "/assessment", label: "Start profile assessment" }} />; }
