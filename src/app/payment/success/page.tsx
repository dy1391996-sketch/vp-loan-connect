...
function InvalidSuccess() {
  return <PublicStatePanel icon={ShieldCheck} eyebrow="Payment verification" title="Verified payment link required" description="Open the confirmation returned after secure server-side payment verification." action={{ href: "/contact", label: "Contact support" }} />;
}
