      ...
      <div className="page-shell">
        <div className="mx-auto max-w-5xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">VP Loan Connect Support can help with an assessment, payment, Credit Profile Booster report, referral or privacy request. Never share a UPI PIN, CVV, bank password or Aadhaar OTP.</p>
          </div>
          ...
          <div id="grievance" className="mt-8 rounded-[2rem] border border-amber-200 bg-amber-50 p-7 sm:p-9">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-amber-950">
              Email <a className="font-bold underline underline-offset-4" href={`mailto:${PUBLIC_GRIEVANCE_EMAIL}?subject=Grievance`}>{PUBLIC_GRIEVANCE_EMAIL}</a> with “Grievance” in the subject and include your registered mobile and order or report reference where relevant.
            </p>
          </div>
        </div>
      </div>
