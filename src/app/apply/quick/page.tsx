...
export const metadata: Metadata = {
  ...
  description:
    "Verify email, complete your profile, then view your eligibility result and matched options. The ₹99 + GST Credit Profile Booster is optional. Not a lender approval.",
