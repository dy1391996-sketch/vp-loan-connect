...
export const metadata: Metadata = {
  ...
  description: "Request deletion or de-identification of your VP Loan Connect profile data after email OTP verification.",
...
export default function DataDeletionPage() {
  return (
    <>
      <PolicyPage
        title="Data Deletion Request"
        summary="Use the verified-email workflow below to request deletion or de-identification of your personal profile data."
        sections={[
          { title: "Before deletion", paragraphs: ["We verify control of the registered email address to reduce unauthorized deletion. We may contact you for clarification through the service channel."] },
      ...
      <section className="surface-grid bg-surface pb-18">
        <div className="page-shell">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">Verify the registered email address, then provide any optional processing context.</p>
            <DataDeletionForm />
          </div>
        </div>
      </section>
