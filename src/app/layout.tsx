...
export const metadata: Metadata = {
  ...
  description: "Check loan options for your profile, then unlock the ₹99 Credit Profile Booster for matched official links. Not a lender — no guaranteed approval.",
