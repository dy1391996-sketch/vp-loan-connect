...
export function MarketingConsentBanner() {
  ...
  const inCheckoutFlow = pathname.startsWith("/apply") || pathname.startsWith("/checkout") || pathname.startsWith("/payment");
  ...
  if (inCheckoutFlow || choice === "loading" || choice !== null) return null;
